#+url: /napkins/2022-10-28-diff-ml-ai/
...
These are not Merriam-Webster’s words but these definitions follow the jist of the respective ideas as presented in our Cornucopia of knowledge, Wikipedia; [[https://en.wikipedia.org/wiki/Machine_learning][ML]] and [[https://en.wikipedia.org/wiki/Artificial_intelligence][AI]]

AI in particular is suited to this definition as it encompasses Modern Systems like [[https://www.deepmind.com/research/highlighted-research/alphago][AlphaGo]] as well as Good Ol’ Fashioned AI like [[https://en.wikipedia.org/wiki/ELIZA][Eliza]] -- also being flexible enough to include things that do not involve “learning from data” such as Static Knowledge Bases or the wizardry yet to be discovered that leads to AGI.
...
For one, some of the technical folk get angry when any system that is capable of something we might call intelligent gets called AI, be it [[https://www.deepmind.com/research/highlighted-research/alphafold][solving protein folding]] or becoming the world’s most [[https://stability.ai/blog/stable-diffusion-public-release][diversely skilled artist]]. In this frame of thought, being able to use a neural network doesn’t make you /intelligent/ -- which is neither fun nor sensical. Systems like AlphaFold exhibit /superhuman intelligence/ on tasks and are also /artificial/, your brain can do the ~sum()~ operation to combine your representations of these two concepts.
